...
public class LevelEditorEntitiesList : MonoBehaviour {
    ...
    private void Awake() {
        ...
        AddListItem(new LevelEntity("Door/Door") { isLogicEntity = true }, "Door/Full Door Sprite");
        ...
        AddListItem(new LevelEntity("Spikes/Spike 0", "Spikes/Spike 1", "Spikes/Spike 2"), "Spikes/Spike Editor Sprite");
    }
}
